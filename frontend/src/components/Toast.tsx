...
const Toast: React.FC<ToastProps> = ({ toast, onRemove, position = 'top-right' }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = `fixed ${getPositionClasses()} z-50 p-4 rounded-lg shadow-xl border transform transition-all duration-300 max-w-sm w-full backdrop-blur-sm`;
    ...
    switch (toast.type) {
      ...
      default:
        return `${baseStyles} bg-gray-500/90 text-white border-gray-400`;
    }
  };
